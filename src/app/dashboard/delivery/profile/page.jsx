...
export default function DeliveryProfilePage() {
    ...
    return (
        <Box>
            <Box sx={{ mb: 5 }}>
                <Typography variant="h4" fontWeight="900">Partner Profile</Typography>
            ...
            <Grid container spacing={4}>
                <Grid item xs={12} md={4}>
                    <Paper sx={{ p: 5, borderRadius: 4, textAlign: 'center', border: '1px solid rgba(0,0,0,0.05)' }}>
                        ...
                        <Typography variant="h6" fontWeight="800">{user?.name || 'Partner'}</Typography>
                ...
                <Grid item xs={12} md={8}>
                    <Paper sx={{ p: 5, borderRadius: 4, border: '1px solid rgba(0,0,0,0.05)' }}>
                        ...
                        <Stack spacing={3}>
                            ...
                            />
                            <TextField
                                fullWidth label="Current Address" name="address"
